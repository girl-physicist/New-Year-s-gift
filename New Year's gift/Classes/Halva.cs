...
namespace New_Year_s_gift.Classes
{
    public class Halva : Sweet
    {
        ...
        public override string TypeOfIngredients => string.Format("{0}", TypeOfHalva);
        public override string ItemInfo => string.Format(" {0},  weight: {1}, price: {2}, sugar: {3}, calories: {4}, {5}"
